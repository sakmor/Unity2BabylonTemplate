if (!navigator.project) {
    ...
    navigator.project.tagName = "BabylonJS.babylon.js";
    navigator.project.scenePath = "scenes/";
    navigator.project.scriptPath = "scripts/";
    navigator.project.projectTitle = "BabylonJS";
    ...
    navigator.project._scriptLibraries.push("scenes/BabylonJS.babylon.js");
    navigator.project._loadProjectScripts(navigator.project._scriptLibraries, 0, "BabylonJS.babylon");
} else {
